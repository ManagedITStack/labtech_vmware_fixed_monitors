...
/*Table structure for table `v_hvhost` */

DROP TABLE IF EXISTS `v_hvhost`;

/*!50001 DROP VIEW IF EXISTS `v_hvhost` */;
/*!50001 DROP TABLE IF EXISTS `v_hvhost` */;

/*!50001 CREATE TABLE  `v_hvhost`(
...
/*View structure for view v_hvhost */
